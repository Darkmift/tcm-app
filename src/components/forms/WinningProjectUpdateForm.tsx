...
import {Project, WinnerProject, Year} from '@/types'
...
type Props = {winningProject: WinnerProject; triggerUpdate: () => void}

function WinningProjectUpdateForm({winningProject, triggerUpdate}: Props) {
  ...
  useEffect(() => {
    setInitialValues({
      ...initialValues,
      project: winningProject.expand.projectId,
      title: winningProject.title,
      year: winningProject.year,
    })
  ...
  const handleSubmit = async (values: any, actions: any) => {
    try {
      ...
      HttpService.updateWinnerProject({
        ...winningProject,
        title: values.title,
        year: values.year,
...
export default WinningProjectUpdateForm
