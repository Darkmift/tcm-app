...
async function handler(req, res) {
  try {
    ...
    const token = (0,jsonwebtoken__WEBPACK_IMPORTED_MODULE_2__.sign)(payload, process.env.JWT_SECRET);
...
var __webpack_exports__ = __webpack_require__.X(0, [2733,7351], () => (__webpack_exec__(2767)));
